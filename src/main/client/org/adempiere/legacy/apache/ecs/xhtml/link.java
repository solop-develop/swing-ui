 ...
 * 
 * @version $Id: link.java,v 1.2 2006/07/30 00:54:02 jjanke Exp $
	...
	implements Printable, MouseEvents, KeyEvents
{
	 ...
	 */
	public link setCharset (String charset)
	{
	 ...
	 * 
	 * @param type
	 *            set the mime type of this link
	 */
	 ...
	 *            Adds an Element to the element.
	 */
	public link addElement (String hashcode, Element element)
	{
	 ...
	 *            Adds an Element to the element.
	 */
	public link addElement (String hashcode, String element)
	{
		addElementToRegistry (hashcode, element);
		return (this);
	}
	 ...
	 */
	public link removeElement (String hashcode)
	{
