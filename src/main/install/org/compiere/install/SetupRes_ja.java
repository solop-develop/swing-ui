...
public class SetupRes_ja extends ListResourceBundle
{
	...
	//
	{ "JavaType",				"Java VM"},
	{ "JavaTypeInfo",			"Java VM ベンダー"},
	{ "AppsType",				"サーバータイプ"},
	{ "AppsTypeInfo",			"J2EEアプリケーションサーバータイプ"},
	{ "ServerDir",				"アプリケーションサーバーディレクトリ"},
	{ "ServerDirInfo",			"J2EEアプリケーションサーバーディレクトリ"},
	{ "ErrorServerDir",			"アプリケーションサーバーディレクトリのエラー"},
	{ "DeployDir",				"デプロイメント"},
	{ "DeployDirInfo",			"J2EEデプロイメントディレクトリ"},
	{ "ErrorDeployDir",			"エラーデプロイメントディレクトリ"},
	//
	{ "TestInfo", 				"\u8a2d\u5b9a\u306e\u30c6\u30b9\u30c8" },
	{ "Test", 					"\u30c6\u30b9\u30c8" },
	{ "SaveInfo", 				"\u8a2d\u5b9a\u306e\u4fdd\u5b58" },
