...
public class SetupRes_pl extends ListResourceBundle
{
	...
	//
	{ "JavaType",				"Java VM"},
	{ "JavaTypeInfo",			"Java VM Sprzedawca"},
	{ "AppsType",				"Rodzaj serwera"},
	{ "AppsTypeInfo",			"Typ serwera aplikacji J2EE"},
	{ "ServerDir",				"Katalog serwera aplikacji"},
	{ "ServerDirInfo",			"Katalog serwera aplikacji J2EE"},
	{ "ErrorServerDir",			"Błąd w katalogu serwera aplikacji"},
	{ "DeployDir",				"Rozlokowanie"},
	{ "DeployDirInfo",			"Katalog wdrażania J2EE"},
	{ "ErrorDeployDir",			"Katalog wdrażania błędów"},
	//
