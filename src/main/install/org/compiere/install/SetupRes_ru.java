...
public class SetupRes_ru extends ListResourceBundle
{
	...
	static final Object	contents[][]	= {
		...
		{ "AppsTypeInfo", "Тип сервера приложений J2EE"},
		{ "ServerDir","Каталог сервера приложений"},
		{ "ServerDirInfo","Каталог сервера приложений J2EE"},
		{ "ErrorServerDir",	"Ошибка в каталоге сервера приложений"},
		{ "DeployDir", "Развертывание"},
		{ "DeployDirInfo", "Каталог развертывания J2EE"},
		{ "ErrorDeployDir", "Каталог ошибок развертывания"},
		//
