...
public class SetupRes_it extends ListResourceBundle
{
	...
	{ "ServerDir",				"Directory del server delle applicazioni"},
	{ "ServerDirInfo",			"Directory server applicazioni J2EE"},
	{ "ErrorServerDir",			"Errore nella directory del server delle applicazioni"},
