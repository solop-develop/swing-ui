...
public class SetupRes_fa extends ListResourceBundle
{
	...
	//
	{ "JavaType",				"Java VM"},
	{ "JavaTypeInfo",			"Java VM فروشنده"},
	{ "AppsType",				"نوع سرور"},
	{ "AppsTypeInfo",			"نوع سرور برنامه J2EE"},
	{ "ServerDir",				"دایرکتوری سرور برنامه"},
	{ "ServerDirInfo",			"راهنمای سرور برنامه J2EE"},
	{ "ErrorServerDir",			"خطا در فهرست سرور برنامه"},
	{ "DeployDir",				"گسترش"},
	{ "DeployDirInfo",			"فهرست استقرار J2EE"},
	{ "ErrorDeployDir",			"فهرست خطاهای استقرار"},
	//
