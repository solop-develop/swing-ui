...
public class SetupRes_no extends ListResourceBundle
{
	...
	//
	{ "JavaType",				"Java VM"},
	{ "JavaTypeInfo",			"Java VM Leverandør"},
	{ "AppsType",				"Servertype"},
	{ "AppsTypeInfo",			"J2EE Application Server Type"},
	{ "ServerDir",				"Katalog for applikasjonsserver"},
	{ "ServerDirInfo",			"J2EE Application Server Directory"},
	{ "ErrorServerDir",			"Feil i Application Server Directory"},
	{ "DeployDir",				"Utplassering"},
	{ "DeployDirInfo",			"J2EE Deployment Directory"},
	{ "ErrorDeployDir",			"Feilimplementeringskatalog"},
	//
